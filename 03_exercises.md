...
```
## Warning in data("garden_harvest"): data set 'garden_harvest' not found
```
...
```
## Warning in data("garden_spending"): data set 'garden_spending' not found
```
...
```
## Warning in data("garden_planting"): data set 'garden_planting' not found
```
